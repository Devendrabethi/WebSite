...
test.describe('Bidder Opportunity - Individual Absentee Mobilia Package', () => {
    ...
    test('01. Start Regular Bidder Mobilia Opportunity', async () => {
        await bidderinvidualpage.BidderOpportunityAbsenteeMobilia()
    })
    ...
    test('08. Bid Method with CC Deposit', async () => {
    ...
    test('11. Enter Dealer CC Deposit Card Details', async () => {
        await bidderdealerpage.CCDepositeCardDetails();
    });

    test('12. View Aggreement Created Bidder Opportunity', async () => {
