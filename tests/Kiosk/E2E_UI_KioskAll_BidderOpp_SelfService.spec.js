...
test.describe('Kiosk Bidder Opportunity with self service mode- Individual With Premium Package, Business with Select Package and Dealer with Absentee Package', () => {
    ...
    test('02. Selecting self service mode', async () => {
        await kioskpage.SelfServiceMode();
    });
