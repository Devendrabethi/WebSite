...
class AddVIN_WebElements
{
    constructor() 
    {
        ...
        this.Make_DropDown = "//span[text()='Make']/parent::div/following-sibling::button"//"(//button[@aria-label='Help'])[1]"
        this.Search_make = "//input[@aria-label='Search']"
        this.Select_SearchMake = "//input[@aria-label='Search']/parent::div/following-sibling::div[1]"
