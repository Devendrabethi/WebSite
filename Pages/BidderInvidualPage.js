...
class BidderInvidualPage
{
    ...
    async AddressDetails()
    {
        ...
        await this.page.locator(this.bidderindividual_webelements.SelectCountyDropdown).click()
        await this.page.locator(this.bidderindividual_webelements.Select_County).click()
        await this.page.locator(this.bidderindividual_webelements.TitlePaperwork).click()
        await this.page.locator(this.bidderindividual_webelements.TitlePaperwork).fill(this.testdata.TitlePaperworkAddress)
        await this.page.locator(this.bidderindividual_webelements.SelectAddress).click()
        await this.page.waitForTimeout(1000)
        await this.page.waitForTimeout(500)
        await this.page.locator(this.bidderindividual_webelements.Vehicleaddress).click()
       ...
       // await this.page.locator(this.titledocument_webelements.CheckboxforAllAddress).click()
        await this.page.locator(this.bidderindividual_webelements.MallingAddress).click()
